...
class DatabanksControllerTest extends AppTestCase
{
    ...
    public function assertDatabankEqualsDump($databank, $suffix = '')
    {
        ...
        exec("gunzip " . escapeshellarg($backupfile . '.sql.gz'));
    ...
    public function testEdit()
    {
        ...
        $this->post('databanks/edit/1',
            ['name' => 'epi_renamed', 'version' => DATABASE_CURRENT_VERSION, 'published' => true]);
        $this->assertResponseCode(302);
    ...
    public function testBackup()
    {
        ...
        exec("gunzip " . escapeshellarg( $outputfile . '.sql.gz'));
