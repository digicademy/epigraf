...
<!-- dieses stylesheet enthält die formatvorlagen 
    zur ausgabe eines inschriftenbands für das 
    textverarbeitungsprogramm MSWord -->

  <!-- 
    das format ist office open xml (OOXML), auch als 
    WordML bezeichnet;
    ...
    spezifikationen zu den formatvorlagen vo OOXML findet man hier:
    http://officeopenxml.com/WPstyles.php
  
  -->
  
  <!-- maßangaben erfolgen in twips (twentieths of a point) 
        zur umrechung in mm, cm, punkt u. dgl. siehe 
        https://www.google.com/search?client=firefox-b-d&q=umrechnung+twips+in+mm
...
<!--    <w:basedOn w:val="Absatz-Standardschriftart"/>-->
  ...
  <!-- Transkription in fussnoten: 9pt (basierend auf epi-normal-2) -->
  <w:style w:type="paragraph" w:styleId="epi-transkription-fn">
    <w:name w:val="epi-transkription-fn"/>
    <w:basedOn w:val="epi-normal-2"/>
    <wx:uiName wx:val="epi-transkription-fn"/>
    <w:pPr>
      <w:pStyle w:val="epi-transkription-fn"/>
      <w:suppressAutoHyphens/>
      <w:widowControl/>
      <w:spacing w:line="260" w:line-rule="exact"/>
      <w:jc w:val="left"/>
...
<!--Pentameterzeile-->
  ...
  <w:style w:type="paragraph" w:styleId="epi-pentameter-fn">
    <w:name w:val="epi-pentameter-fn"/>
    <w:basedOn w:val="epi-normal-2"/>
    <wx:uiName wx:val="epi-pentameter-fn"/>
    <w:pPr>
      <w:pStyle w:val="epi-pentameter"/>
      <w:suppressAutoHyphens/>
      <w:widowControl/>
 ...
 <!--Ubersetzung am Ende jedes Inschriftenteils-->
  <w:style w:type="paragraph" w:styleId="epi-uebersetzung2">
    ...
    <w:pPr>
      <w:pStyle w:val="epi-uebersetzung2"/>
        <w:spacing w:before="120" w:after="240"/><w:ind w:left="351"/>
    </w:pPr>
    <w:rPr>
      <w:sz w:val="18"/>
    </w:rPr>
  ...
  <w:style w:type="paragraph" w:styleId="epi-ueberschrift-9">
    <w:name w:val="epi-ueberschrift-9"/>
    <wx:uiName wx:val="epi-überschrift-9"/>
    <w:basedOn w:val="epi-normal-1"/>
    <w:pPr>
      <w:pStyle w:val="epi-ueberschrift-8"/>
      <w:widowControl w:val="on"/>
  ...
  <!-- wappenbeschreibungen / blasonierungen -->
  <w:style w:type="paragraph" w:styleId="epi-blasonierung-eintrag">
    <w:name w:val="epi-blasonierung-eintrag"/>
    <w:basedOn w:val="epi-normal-1"/>
    <wx:uiName wx:val="epi-blasonierung-eintrag"/>
    <w:pPr>
