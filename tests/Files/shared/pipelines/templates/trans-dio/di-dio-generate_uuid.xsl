...
<!-- Quelle: https://gist.github.com/azinneera/778f69ae6b0049b5edcd69da70072405 -->
...
<!-- die funktion wird wie folgt aufgerufen: <xsl:attribute name="uid" select="uuid:get-uuid(drinkName)"/>  

statt drinkName muss ein relevanter Pfad (oder ein parameter oder eine variable) angegeben werden

-->

	<!-- Functions in the uuid: namespace are used to calculate a UUID 
		The method used is a derived timestamp method, which is explained here: 
		http://www.famkruithof.net/guid-uuid-timebased.html and here: 
