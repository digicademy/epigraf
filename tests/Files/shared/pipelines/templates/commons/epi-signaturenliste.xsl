...
<xsl:template match="book">
 ...
 <Worksheet ss:Name="Abbildungen">
  <Table ss:ExpandedColumnCount="5" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0">
       <Cell ss:Index="3" ss:StyleID="s76"><Data ss:Type="String">3. die gespeicherte Datei auf EpigrafWeb in den Ordner &quot;Dateien/projects/<xsl:value-of select="project/signature"/>&quot; hochladen</Data></Cell>
   </Row>
