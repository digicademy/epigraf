...
<!--            <Cell ss:StyleID="s62"><Data ss:Type="String">Artikelnummer</Data></Cell>-->
          ...
          <xsl:for-each select="/book/articles/article">
            <Row>
              <!-- artikel-signatur -->
              <Cell>
              ...
              <Cell>
                <Data ss:Type="String">
                            ...
                            <xsl:if test="following-sibling::location">; </xsl:if>
                            </xsl:for-each>
                    </Data>
              </Cell>
              ...
              <!-- Inschriftenträger -->
              <Cell>
                <Data ss:Type="String"><xsl:value-of select="object"/></Data>
              </Cell>
...
<!--              <!-\-  -\->
              ...
              <!-- ID -->
              <Cell>
                <Data ss:Type="String"><xsl:value-of select="substring-after(@id,'-')"/></Data>
              </Cell>
