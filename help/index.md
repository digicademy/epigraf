...
![Epigraf Modules](assets/img/modules.png)
...
Epigraf emerged from the inter-academic edition project "The German Inscriptions of the Middle Ages and the Early Modern Period". It is used in the nine inscription research centers of the six participating academies of sciences. The application is being developed by the Digital Academy of Sciences and Literature | Mainz and the Digital Media & Computational Methods Research Group at the University Münster.

Epigraf is an open source project under active development. We are on our way to prepare the application for other projects.
[Source code](https://github.com/digicademy/epigraf) and [developer documentation](https://digicademy.github.io/epigraf/) are released on GitHub after major updates. We are open to collaborative development and appreciate getting in touch with you.
