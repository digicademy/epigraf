...
To prepare data imports, a basic understanding of the [data model](../coreconcepts/model) will be helpful.
...
-   **IRI paths** (Internationalized Resource Identifiers) are particularly flexible and recommended, as they allow [data transfer](export/transfer) between different databases without knowing the internal database IDs. They are formed according to the scheme `<table>/<type>/<irifragment>`. Example: `properties/languages/iso-de-de`.
