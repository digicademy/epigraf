...
//        'defaultTimezone' => env('APP_DEFAULT_TIMEZONE', 'UTC'),
        ...
        // Enable or disable EpiDesktop compatibility mode
        'epidesktop' => false,
...
//        ],
        ...
        'webroot' => 'htdocs',
        'wwwRoot' => WWW_ROOT,
        'cors' => [], // List of domains for cors headers, e.g. ['inschriften.net','*.inschriften.net']
        //'fullBaseUrl' => false,
        'imageBaseUrl' => 'img/',
        'cssBaseUrl' => 'css/',
        'jsBaseUrl' => 'js/',
     ...
     * The standard configuration uses a file cache.
     * See below for alternative Redis configuration.
     */
    'Cache' => [
        'default' => [
        ...
        /**
         * Configure the cache for exported indexes, rendered views, and query results
         */
        'index' => [
            'className' => FileEngine::class,
...
//       ]
    ...
    'Datasources' => [
        'default' => [
            ...
            'driver' => Mysql::class,
            'persistent' => false,
            'host' => '__DBHOST__',          // env('MYSQL_HOST')
            'port' => '__DBPORT__',          // Standard mySQL port: 3306
            'username' => '__DBUSERNAME__',  // env('MYSQL_USER'),
            'password' => '__DBPASSWORD__',  // env('MYSQL_PASSWORD'),
            'database' => 'epigraf',
            'encoding' => 'utf8mb4',
        ...
        'projects' => [
            ...
            'persistent' => false,
            'host' => '__DBHOST__',            //env('MYSQL_HOST'),
            'port' => '__DBPORT__',            //env('MYSQL_PORT'),
            'username' => '__DBUSERNAME__',    //env('MYSQL_USER'),
            'password' => '__DBPASSWORD__',    //env('MYSQL_PASSWORD'),
            'database' => '',
            'encoding' => 'utf8mb4',
