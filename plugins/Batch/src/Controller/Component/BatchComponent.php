...
namespace Batch\Controller\Component;
 ...
 *
 * - See BatchComponent->transfer() method.
 * - See JobTransfer which derivates from JobImport.
 * - See Batch/transfer.php for the settings.
 *
 */
class BatchComponent extends Component
{
    ...
    public function import($scope = null)
    {
        ...
        if (!$this->request->is('api')) {
            ...
            $this->controller->setPlugin('Batch');
            $this->controller->render('Batch/import');
        }
        else {
    ...
    public function transfer($scope = null, $params = [])
    {
        ...
        $this->controller->set(compact('job', 'scope', 'stage'));
        $this->controller->setPlugin('Batch');
        $this->controller->render('Batch/transfer');
    }
    ...
    public function export($scope = null, $params = [])
    {
        ...
        $this->controller->setPlugin('Batch');
        $this->controller->render('Batch/export');
    }
    ...
    public function mutate($scope = null)
    {
        ...
        $this->controller->setPlugin('Batch');
        $this->controller->render('Batch/mutate');
    }
}
