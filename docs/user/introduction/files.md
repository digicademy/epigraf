...
permalink: '/epigraf/user/introduction/files/'
---
...
-   backup: This is where the [database backups](/epigraf/user/administration/databases) are located.
-   jobs: contains the result of [pipeline](/epigraf/user/export/pipelines) jobs.
-   import: [Imported CSV files](/epigraf/user/import/csv) are temporarily stored in this location.
