...
permalink: '/epigraf/user/administration/files/'
---
...
``` plaintext
{
  "origin": "https://gitlab.rlp.net/adwmainz/digicademy/di/epigraf/epipresets/-/archive/epigraf/devel/epipresets-devel.zip",
