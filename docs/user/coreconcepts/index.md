...
**Path Extraction Language**: Epigraf uses object-relational mapping to load data from databases into objects.
Extraction keys are then used to retrieve the nested data for display in flat tables.
