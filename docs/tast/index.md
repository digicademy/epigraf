...
- [Backend tests](/tests/backend) use PHPUnit. They call endpoints and test whether the output
...
- [Frontend tests](/tests/frontend) use Jest and check JavaScript code from the widgets.
- [Acceptance tests](/tests/acceptance) use Codeception. They check the appearance and interactivity of the frontend
